...
@Repository
public interface PhysicalStagingareaConfigurationRepository extends JpaRepository<PhysicalStagingareaConfiguration, PhysicalStagingareaConfiguration.PrimaryKey> {
}